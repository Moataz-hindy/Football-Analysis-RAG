...
def compute_discussion_agreement(
    ...
    if round_agreements:
        mean_agr = round(sum(ra.agreement_score for ra in round_agreements) / len(round_agreements), 4)
        first_score = round_agreements[0].agreement_score
        last_score = round_agreements[-1].agreement_score
